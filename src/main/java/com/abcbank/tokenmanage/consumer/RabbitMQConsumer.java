...
public class RabbitMQConsumer {
	...
	public RabbitMQConsumer(String consumerName, String routingKey, String queueName,
			ConnectionFactory connectionFactory, Receiver receiver) {
	...
	/*
	 * Creates a queue for a specific operation if it is not present and binds the
	 * counter to the queue.If a queue is already present for the specific operation
	 * the counter is binded to the queue.
	 */
